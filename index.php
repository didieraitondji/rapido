...
?>
    ...
    <body class=" bg-info ">
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 pt-5">
                    <div class="login-form monbg-color-2 pt-4 pb-4 rounded-4 shadow">
                        <img src="assets/images/logo.png" alt="logo Rapido" width="165px
                    " class="d-block mx-auto logo-rapido">
                        <h2 class="text-center mx-5 mb-3 text-light p-2 pb-3 border-bottom ">Connexion</h2>
        ...
        if (isset($_SESSION['message']) && $_SESSION['message'] != null) {
            echo '<div class="notification" style="bottom:5px">' . $_SESSION['message'] . '</div>';
        }
