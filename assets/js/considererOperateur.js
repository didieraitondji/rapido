...
if (ajoutbtn) {
    ajoutbtn.addEventListener("click", ()=>{
        ...
        titre.innerText = "Ajouter Opérateur ";
        ...
        lesInput[4].setAttribute("value", "Ajouter l'opérateur");
...
// mise en places des modales de modification des informations sur l'opérateur
if (modifier) {
...
if (retirer) {
    retirer.forEach(element => {
        element.addEventListener("click", ()=>{
            confirmAction("Voulez-vous considérer cet Opérateur ? ", element.getAttribute("id"));
        });
    }); 
}
...
if (plus) {
    plus.forEach(element => {
        element.addEventListener("click", ()=>{
            ...
            divInfos[2].innerText = lesTD[4].textContent;
            divInfos[3].innerText = lesTD[3].textContent;
            divInfos[4].innerText = lesTD[5].textContent;
            divInfos[5].innerText = lesTD[6].textContent;
            divInfos[6].innerText = lesTD[7].textContent;
            ...
            retirerPlus.addEventListener("click", ()=>{
                ...
                confirmAction("Voulez-vous considérer cet Opérateur ? ", url);
            });
