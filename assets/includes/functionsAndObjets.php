...
function jeRedirect($url)
{
    echo "<script>window.location.replace('$url');</script>";
}

//fonction de redirection html
function redirect_html($url, $delay = 0)
{
    echo "<meta http-equiv='refresh' content='$delay;url=$url'>";
}

//creation de quelques classes
...
class Chauffeur extends Users
{
    ...
    public function allChauffeurDispo()
    {
        ...
        $sql = 'SELECT * FROM chauffeurs WHERE disponible=0 AND retirer=0';
        $req = $pdo->prepare($sql);
        $req->execute();
    ...
    {
        $pdo = $this->base->connecteBase(1);
        $sql = 'SELECT * FROM chauffeurs WHERE disponible=1 AND retirer=0';
        $req = $pdo->prepare($sql);
        $req->execute();
    ...
    {
        $pdo = $this->base->connecteBase(1);
        $sql = 'SELECT * FROM chauffeurs WHERE retirer=0';
        $req = $pdo->prepare($sql);
        $req->execute();
    ...
    public function allChauffeurRE()
    {
        $pdo = $this->base->connecteBase(1);
        $sql = 'SELECT * FROM chauffeurs WHERE retirer=1';
        $req = $pdo->prepare($sql);
        $req->execute();
    ...
    public function retirerChauffeur($id)
    {
        ...
        $sql = 'UPDATE chauffeurs SET retirer = ? WHERE chauffeur_id = ? AND disponible = 0';
        $req = $pdo->prepare($sql);
    ...
    public function considererChauffeur($id)
    {
        $d = 0;
        $pdo = $this->base->connecteBase();

        $sql = 'UPDATE chauffeurs SET retirer = ? WHERE chauffeur_id = ?';
        $req = $pdo->prepare($sql);
...
class Operateur extends Users
{
    ...
    public function allOperateur($a = 0)
    {
        if ($a == 0) {
            ...
            $sql = 'SELECT * FROM operateurs WHERE retirer=0';
            ...
            $sql = 'SELECT * FROM operateurs WHERE retirer=0 ORDER BY operateur_id DESC';
    ...
    public function allOperateurRE($a = 0)
    {
        if ($a == 0) {
            $pdo = $this->base->connecteBase(1);

            $sql = 'SELECT * FROM operateurs WHERE retirer=1';
            ...
            $sql = 'SELECT * FROM operateurs WHERE retirer=1 ORDER BY operateur_id DESC';
    ...
    public function retirerOperateur($id)
    {
        ...
        $sql = 'UPDATE operateurs SET retirer = ? WHERE operateur_id = ?';
        $req = $pdo->prepare($sql);
    ...
    public function considererOperateur($id)
    {
        $d = 0;
        $pdo = $this->base->connecteBase();
...
class Course
{
    ...
    public function addCourseAsAdminOderByOperateur()
    {
        $pdo = $this->base->connecteBase();
        $sql = 'INSERT INTO courses (point_depart, point_arrivee, date_heure, admin_created_id, operateur_id, statut) VALUES (?,?,?,?,?,?)';
        $req = $pdo->prepare($sql);

        try {
            $req->execute([$this->donnee['point_depart'], $this->donnee['point_arrivee'], $this->donnee['date_heure'], $this->donnee['admin_created_id'], $this->donnee['operateur_id'], $this->donnee['statut']]);
    ...
    public function allCoursesOperateur($id, $b = 0, $a = 0)
    {
        if ($b == 0) {
            $pdo = $this->base->connecteBase(1);
            if ($a == 0) {
                $sql = 'SELECT * FROM courses WHERE operateur_id=' . $id . ' AND statut=0';
            } else {
                $sql = 'SELECT * FROM courses ORDER BY course_id DESC WHERE operateur_id = ' . $id . ' AND statut=0';
            }
            ...
            $pdo = $this->base->connecteBase(1);
            if ($a == 0) {
                $sql = 'SELECT * FROM courses WHERE operateur_id=' . $id . ' AND statut=1';
            } else {
                $sql = 'SELECT * FROM courses ORDER BY course_id DESC WHERE operateur_id = ' . $id . ' AND statut=1';
            }
            ...
            $pdo = $this->base->connecteBase(1);
            if ($a == 0) {
                $sql = 'SELECT * FROM courses WHERE operateur_id=' . $id . ' AND statut=2';
            } else {
                $sql = 'SELECT * FROM courses ORDER BY course_id DESC WHERE operateur_id = ' . $id . ' AND statut=2';
            }
