...
if (isset($_SESSION['connect']) && $_SESSION['connect'] == "oui") {
    ...
    if ($_SESSION['type'] == "admin") {
        $id = $_SESSION['IDparticule'];
    } else {
        $id = $_SESSION['info']['id'];
    }

    if ($_SESSION['type'] == "operateur" || $_SESSION['type'] == "admin") {
...
?>
        ...
        <head>
            ...
            <title> <?php
                    if (isset($_SESSION['type']) && $_SESSION['type'] != null) {
                        if ($_SESSION['info'] != 4) {
                            echo getOperateurName($id);
                        }
                    }
                    ?> | Espace Personel | Opérateur Rapido | Historique </title>
        ...
        <body>
                ...
                <div class="container">
                    ...
                    <div class="card mb-5 mt-4 ">
                        <div class="card-header fw-bold ">
                            ...
                            Historique complet de toutes vos courses Terminés
                        </div>
                        <div class="card-body">
                                    ...
                                    if (debutTbody($i) == 1) { ?>
                                        ...
                                        <tr class="text-center border uneLigne">
                                            ...
                                            <td class="border py-3 chauffeur">
                                                ...
                                                $result2 = $opt2->allChauffeur();

                                                foreach ($result2 as $b) {

                                                    if ($a['chauffeur_id'] == $b['chauffeur_id']) {
                                                        echo $b['nom'] . ' ' . $b['prenoms'] . ' (' . $b['telephone'] . ')';
                                                    }
                                                }
                                                ?>
                                            </td>
            ...
            <script src="/assets/js/scripteOperateurPerso.js"></script>
        </body>
