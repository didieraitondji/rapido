...
?>
        ...
        <body>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link actif dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Corbeille
                                    </a>
                            ...
                            <table class="table table-hover">
                                <thead class="table-dark w-100">
                                    <tr class="text-center border border-black">
                                        ...
                                        <th colspan="2" class="operations">Opérations</th>
                                ...
                                foreach ($result as $a) {
                                    ...
                                    if (debutTbody($i) == 1) { ?>
                                        ...
                                        <tr class="text-center border nom<?php echo $a['telephone']; ?>">
                                            ...
                                            <td class="operations py-3 d-none">
                                                <a href="/assets/includes/agirOperateur.php?id=<?php echo $a['operateur_id']; ?>" target="_blank" class="btn fw-bold py-0 px-2 action1">
                                            ...
                                            <td class="operations py-3">
                                                <span class="btn fw-bold bg-success text-white py-0 px-2 action2 retirer" id="/assets/includes/considererOperateur.php?id=<?php echo $a['operateur_id']; ?>">
            ...
            <footer class="monbg-color-2 text-white">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mx-auto fw-bold" style="width: max-content; font-size: 0.8em; height: 22px;" id="droit"> &copy; Copyright - RAPIDO 2024 - </div>
                        </div>
                        <div class="col">
            ...
            <div class="ajoutModal p-0 pt-5">
                <div class="ajoutModal-content">
                    ...
                    <div class="image-formulaire">
                        ...
                        <div class="formulaire container" id="premier-index">
                            ...
                            <form method="post" class="formemaj">
                                ...
                                <input type="text" name="nom" id="nom" placeholder="nom de l'opérateur ...">
                                <label for="prenoms">Prénoms :</label><br>
                                <input type="text" name="prenoms" placeholder="prénoms de l'opérateur" id="nom">
                                ...
                                <input type="submit" value="Ajouter Opérateur" class="bg-success text-light border-0 mt-4">
                                <hr>
                    ...
                    <div class="information-plus p-3 w-auto">
                        <h3 class=" mb-3 "> Informations sur l'Opérateur </h3>
                        ...
                        <div class=" container-fluid p-4 border mt-2">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-6 mb-3 text-center">
                                    <span class="btn fw-bold py-1 px-2 w-100 action1 modifierPlus" title=" Modifier cet Opérateur ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                        </svg>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3 text-center d-none">
                                    <a href="" class="btn fw-bold py-1 px-2 w-100 action1 agirPlus" title=" Agir comme cet Opérateur ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-rolodex" viewBox="0 0 16 16">
                                            <path d="M8 9.05a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5" />
                                            <path d="M1 1a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h.5a.5.5 0 0 0 .5-.5.5.5 0 0 1 1 0 .5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5.5.5 0 0 1 1 0 .5.5 0 0 0 .5.5h.5a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H6.707L6 1.293A1 1 0 0 0 5.293 1zm0 1h4.293L6 2.707A1 1 0 0 0 6.707 3H15v10h-.085a1.5 1.5 0 0 0-2.4-.63C11.885 11.223 10.554 10 8 10c-2.555 0-3.886 1.224-4.514 2.37a1.5 1.5 0 0 0-2.4.63H1z" />
                                        </svg>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3 text-center d-none">
                                    <span href="" class="btn fw-bold py-1 px-2 w-100 action1 resetPlus" title=" Réinitialiser le mot de passe de l'opérateur ">
                                ...
                                <div class="col-12 col-sm-12 col-md-6 mb-3 text-center">
                                    <span class="btn fw-bold bg-success text-white py-1 px-2 w-100 action2 retirerPlus" id="/assets/includes/considererOperateur.php ?id=<?php echo $a['operateur_id']; ?>" title=" Retirer l'opérateur ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash2" viewBox="0 0 16 16">
                                            <path d="M14 3a.7.7 0 0 1-.037.225l-1.684 10.104A2 2 0 0 1 10.305 15H5.694a2 2 0 0 1-1.973-1.671L2.037 3.225A.7.7 0 0 1 2 3c0-1.105 2.686-2 6-2s6 .895 6 2M3.215 4.207l1.493 8.957a1 1 0 0 0 .986.836h4.612a1 1 0 0 0 .986-.836l1.493-8.957C11.69 4.689 9.954 5 8 5s-3.69-.311-4.785-.793" />
                                        </svg>
                                        Considérer
            ...
            <script src="/assets/js/considererOperateur.js"></script>
        </body>
