...
?>
        ...
        <head>
            ...
            <title>Courses | Page Entreprise</title>
        ...
        <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link actif" href="/entreprise/courses/">Courses</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="container">
                    ...
                    <div class="card mb-5 ">
                        ...
                        <div class="card-header fw-bold ">
                            <div class="row">
                                <div class="col-6">
                                    <span>Les courses chez RAPIDO</span>
                                </div>
                                <div class="col-6">
                                    <div class=" float-end add-operator d-flex flex-column align-items-end">
                                        <select name="trie_course" id="trie_course" class=" p-2 " style="width: 200px;">
            ...
            <script src="/assets/js/scripteCourse.js"></script>
        </body>
