...
if (isset($_SESSION['connect']) && $_SESSION['connect'] == "oui") {
    ...
    if ($_SESSION['type'] == "chauffeur" || $_SESSION['type'] == "admin") {
?>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <head>
            ...
            <title>
                ...
                if (isset($_SESSION['type']) && $_SESSION['type'] != null) {
                    if ($_SESSION['info'] != 4) {
                        echo getChauffeurName($id);
                    }
                }
                ?>
                | Espace personnel | Chauffeurs RAPIDO </title>
        ...
        <body class=" pt-5 ">
            ...
            <div class="container-fluid contenu">
                <div class="container">
                    <div class="card mb-5 mt-3 " id="<?php echo $id; ?>">
            ...
            <script src="../assets/js/scriptChauffeurPerso.js"></script>
        </body>
